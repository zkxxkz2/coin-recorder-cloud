...
### v6.2.4 (最新版本)
- **历史记录倒序显示**：最新记录优先展示，便于查看最新数据
- **移动端布局优化**：改用垂直布局，解决数据拥挤问题
- **日期显示增强**：字体18px、加粗，提升可读性
- **项目高度增加**：最小高度80px，内边距20px 16px
- **间距优化**：内容区域与操作区域分离，添加分隔线
- **金币显示优化**：字体16px，与日期层级清晰
- **备注行高调整**：line-height 1.4，提升可读性
- **按钮区域优化**：操作区域独立，边界清晰
