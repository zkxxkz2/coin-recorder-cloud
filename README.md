...
### v5.8.0 (最新版本)
- **按钮布局重构**: 将刷新和加入/退出按钮设计为并排的细长按钮，提升操作便捷性
- **窄屏深度优化**: 针对480px以下屏幕完全重构排行榜布局，解决长方形块卡片显示问题
- **用户体验增强**: 优化了排行榜在极端窄屏幕下的可读性和交互性
- **视觉层次完善**: 通过合理的元素尺寸和间距，确保在各种设备上都有良好的显示效果
- **触摸友好改进**: 优化按钮尺寸和点击区域，提升移动端操作体验
